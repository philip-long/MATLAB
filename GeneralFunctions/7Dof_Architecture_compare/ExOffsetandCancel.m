...
%
%
%   Name of file : D:/Mes documents/functions/PythonInputs/jac/Test2.jac
%
%
%
%
...
J(1,1) = -(d3*cos(t2)*sin(t1)) - d4*cos(t2)*cos(t3)*sin(t1)+...
  r3*sin(t1)*sin(t2) + r5*cos(t4)*sin(t1)*sin(t2)+...
  r7*cos(t4)*cos(t6)*sin(t1)*sin(t2) - d4*cos(t1)*sin(t3)-...
...
J(2,1) = d3*cos(t1)*cos(t2) + d4*cos(t1)*cos(t2)*cos(t3)-...
  r3*cos(t1)*sin(t2) - r5*cos(t1)*cos(t4)*sin(t2)-...
  r7*cos(t1)*cos(t4)*cos(t6)*sin(t2) - d4*sin(t1)*sin(t3)+...
...
J(1,2) = -(r3*cos(t1)*cos(t2)) - r5*cos(t1)*cos(t2)*cos(t4)-...
  r7*cos(t1)*cos(t2)*cos(t4)*cos(t6) - d3*cos(t1)*sin(t2)-...
  d4*cos(t1)*cos(t3)*sin(t2) - r5*cos(t1)*cos(t3)*sin(t2)*sin(t4)-...
...
J(2,2) = -(r3*cos(t2)*sin(t1)) - r5*cos(t2)*cos(t4)*sin(t1)-...
  r7*cos(t2)*cos(t4)*cos(t6)*sin(t1) - d3*sin(t1)*sin(t2)-...
  d4*cos(t3)*sin(t1)*sin(t2) - r5*cos(t3)*sin(t1)*sin(t2)*sin(t4)-...
...
J(3,2) = d3*cos(t2) + d4*cos(t2)*cos(t3) - r3*sin(t2) - r5*cos(t4)*sin(t2)-...
  r7*cos(t4)*cos(t6)*sin(t2) + r5*cos(t2)*cos(t3)*sin(t4)+...
  r7*cos(t2)*cos(t3)*cos(t6)*sin(t4)-...
...
J(1,3) = -(d4*cos(t3)*sin(t1)) - d4*cos(t1)*cos(t2)*sin(t3)-...
  r5*cos(t3)*sin(t1)*sin(t4) - r7*cos(t3)*cos(t6)*sin(t1)*sin(t4)-...
...
J(2,3) = d4*cos(t1)*cos(t3) - d4*cos(t2)*sin(t1)*sin(t3)+...
  r5*cos(t1)*cos(t3)*sin(t4) + r7*cos(t1)*cos(t3)*cos(t6)*sin(t4)-...
...
J(3,3) = -(d4*sin(t2)*sin(t3)) - r5*sin(t2)*sin(t3)*sin(t4)-...
  r7*cos(t6)*sin(t2)*sin(t3)*sin(t4)+...
