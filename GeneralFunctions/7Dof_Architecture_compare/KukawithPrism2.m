...
%
%
%   Name of file : D:/Mes documents/functions/SYMORO tests/KukawithPrism2.jac
%
%
%
%
...
J(1,7) = -(cos(t1)*cos(t4)*cos(t6)*sin(t2))+...
...
J(2,7) = -(cos(t4)*cos(t6)*sin(t1)*sin(t2))+...
...
J(3,7) = cos(t2)*cos(t4)*cos(t6) + cos(t3)*cos(t6)*sin(t2)*sin(t4)-...
