...
qcut=u(1:length(qinit)); % Cutting Robot
qvision=u(length(qinit)+1:length(qinit)+7);% Vision Robot
...
p01=T70_B(qcut);p01=[p01(1:3,4);1];
p02=T70(qcut);p02=[p02(1:3,4);1];
 
% 2. Find the location of the points in the vision robot's end
% effector frame
Transvision=T70_0C(qvision);
P1=Transvision\p01;
P2=Transvision\p02;
