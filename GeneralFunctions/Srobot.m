...
%
%
%   Name of file : D:/Mes documents/functions/SYMORO tests/Srobot.jac
%
%
%
%
...
J(1,1) = RL4*cos(t1)*cos(t3) - d3*cos(t2)*sin(t1) + RL4*cos(t2)*sin(t1)*sin(t3);

J(2,1) = d3*cos(t1)*cos(t2) + RL4*cos(t3)*sin(t1) - RL4*cos(t1)*cos(t2)*sin(t3);
...
J(1,2) = -(d3*cos(t1)*sin(t2)) + RL4*cos(t1)*sin(t2)*sin(t3);

J(2,2) = -(d3*sin(t1)*sin(t2)) + RL4*sin(t1)*sin(t2)*sin(t3);

J(3,2) = d3*cos(t2) - RL4*cos(t2)*sin(t3);
...
J(1,3) = -(RL4*cos(t1)*cos(t2)*cos(t3)) - RL4*sin(t1)*sin(t3);

J(2,3) = -(RL4*cos(t2)*cos(t3)*sin(t1)) + RL4*cos(t1)*sin(t3);

J(3,3) = -(RL4*cos(t3)*sin(t2));
