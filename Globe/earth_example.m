...
%% Options
space_color = 'w';
npanels = 400;   % Number of globe panels around the equator deg/panel = 360/npanels
...
erad    = 1.0;%6371008.7714; % equatorial radius (meters)
prad    = 1.0;%6371008.7714; % polar radius (meters)
...
cdata_scaled=imresize(cdata,size(x))
set(globe, 'FaceColor', 'texturemap', 'CData', cdata_scaled, 'FaceAlpha', alpha, 'EdgeColor', 'none');
