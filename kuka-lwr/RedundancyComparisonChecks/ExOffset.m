...
%
%
%   Name of file : D:/Mes documents/functions/PythonInputs/jac/Test1.jac
%
%
%
%
...
J(1,1) = -0.5*cos(t2)*sin(t1) + r3*sin(t1)*sin(t2)+...
  r5*cos(t4)*sin(t1)*sin(t2) + r7*cos(t4)*cos(t6)*sin(t1)*sin(t2)-...
...
J(2,1) = 0.5*cos(t1)*cos(t2) - r3*cos(t1)*sin(t2)-...
  r5*cos(t1)*cos(t4)*sin(t2) - r7*cos(t1)*cos(t4)*cos(t6)*sin(t2)+...
...
J(1,2) = -(r3*cos(t1)*cos(t2)) - r5*cos(t1)*cos(t2)*cos(t4)-...
  r7*cos(t1)*cos(t2)*cos(t4)*cos(t6) - 0.5*cos(t1)*sin(t2)-...
...
J(2,2) = -(r3*cos(t2)*sin(t1)) - r5*cos(t2)*cos(t4)*sin(t1)-...
  r7*cos(t2)*cos(t4)*cos(t6)*sin(t1) - 0.5*sin(t1)*sin(t2)-...
...
J(3,2) = 0.5*cos(t2) - r3*sin(t2) - r5*cos(t4)*sin(t2)-...
