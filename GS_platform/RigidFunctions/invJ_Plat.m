function [Jinv] = invJ_Plat(q)
%J_Plat This functions returns the jacobian matrix of the gough stewart robot, which relates the the platform velocity actued joint velocity
...
%J_Plat This functions returns the jacobian matrix of the gough stewart platform
%
%
...
L01=T0M_init*PM1; L02=T0M_init*PM2; L03=T0M_init*PM3;
L04=T0M_init*PM4; L05=T0M_init*PM5; L06=T0M_init*PM6;
